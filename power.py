...
def power_balance_calculation(length, bandwidth, equipment):
...
def generate_report(file_path):
    ...
    for index, row in df.iterrows():
        ...
        report.append({
            ...
            'Power Consumption (W)': f'{power_consumption:.2f}'
        })
    ...
    # Save report to CSV
    report_df.to_csv('power_balance_report.csv', index=False)
    print(f'Total Power Balance for the network: {total_power_balance:.2f} W')
